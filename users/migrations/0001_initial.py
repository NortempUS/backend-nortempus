    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.TextField(choices=[('hombre', 'Hombre'), ('mujer', 'mujer'), ('otro', 'Otro'), ('prefiero no decir', 'Prefiero no decir')])),
                ('total_points', models.PositiveIntegerField(default=0)),
                ('number_of_services', models.PositiveIntegerField(default=0)),
                ('plan', models.TextField(choices=[('basico', 'Básico'), ('premium', 'Premium')], default='basico')),
